...
player setVariable ["loadout","LIMA_Standard"];
_notloadeditems = [];
...
_fits = player canAddItemToUniform uav_Terminal;
if (_fits) then {
	player addItemToUniform uav_Terminal;
}
else {
	_fits = false;
	_fits = player canAdd uav_Terminal;
	if (_fits) then {
		player addItem uav_Terminal;
	}
	else {
		_notloadeditems pushback uav_Terminal;
	};
};
...
_fits = player canAddItemToUniform "ToolKit";
if (_fits) then {
	player addItemToUniform "ToolKit";
}
else {
	_fits = false;
	_fits = player canAdd "ToolKit";
	if (_fits) then {
		player addItem "ToolKit";
	}
	else {
		_notloadeditems pushback "ToolKit";
	};
};

_fits = player canAddItemToUniform "ACE_Fortify";
if (_fits) then {
	player addItemToUniform "ACE_Fortify";
}
else {
	_fits = false;
	_fits = player canAdd "ACE_Fortify";
	if (_fits) then {
		player addItem "ACE_Fortify";
	}
	else {
		_notloadeditems pushback "ACE_Fortify";
	};
};

_fits = player canAddItemToUniform minedetector;
if (_fits) then {
	player addItemToUniform minedetector;
}
else {
	_fits = false;
	_fits = player canAdd minedetector;
	if (_fits) then {
		player addItem minedetector;
	}
	else {
		_notloadeditems pushback minedetector;
	};
};
