...
//------------------------------------------------------------------
//
//			Schwerpunktmaterial nach Gruppen
//
//------------------------------------------------------------------
//------------------------------------------------------------------	
_bravo = [
...
if (_loadout == "Zug_Truppfuhrer") then {
	...
	//						Delta
	//------------------------------------------------------------------	
	if (_playerGrp == grpdelta) then {
		_equipment = _equipment + _rifles_grenadier;
	};
...
//						Bravo
//------------------------------------------------------------------	
if (_playerGrp == grpbravo) then {
	_equipment = _equipment + _bravo;
};
...
//						Kilo // Lima
//------------------------------------------------------------------
if (_playerGrp == grpkilo || _playerGrp == grplima || _playerGrp == grpfox || _playerGrp == grpmike) then {
	_equipment = 
					_uniforms +
					_vests +
					_vests_san +
